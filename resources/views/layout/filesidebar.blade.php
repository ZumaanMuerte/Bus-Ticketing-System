<div class="fixed top-16 left-0 h-[calc(100vh-64px)] bg-white shadow-md flex flex-col p-5
    ...
    <ul class="space-y-4">
        ...
        <li>
            <a href="{{ route('ticketsales') }}" class="group flex items-center font-semibold text-gray-700 p-2 rounded-lg transition
                                hover:bg-blue-900 hover:text-white">
                <img src="{{ asset('icons/File(dark).png') }}" alt="Person" class="w-6 h-6 transition
                                group-hover:invert group-hover:brightness-100">
                <span class="ml-2 md:hidden lg:inline-block">Ticket Sales</span>
            </a>
        </li>
        <li>
            <a href="{{ route('earnings') }}" class="group flex items-center font-semibold text-gray-700 p-2 rounded-lg transition
                                hover:bg-blue-900 hover:text-white">
                <img src="{{ asset('icons/stars(dark).png') }}" alt="Person" class="w-6 h-6 transition
                                group-hover:invert group-hover:brightness-100">
                <span class="ml-2 md:hidden lg:inline-block">Earnings</span>
            </a>
        </li>
    </ul>
