    ...
    <ul class="space-y-4">
        <li>
            <a href="{{ route('homepage') }}" class="group flex items-center font-semibold text-gray-700 p-2 rounded-lg transition
                ...
                <img src="{{ asset('icons/home(dark).png') }}" alt="Home" class="w-6 h-6 transition
                                group-hover:invert group-hover:brightness-100">
                <span class="ml-2 md:hidden lg:inline-block">Home</span>
            </a>
        </li>
        <li>
            <a href="{{ route('account') }}" class="group flex items-center font-semibold text-gray-700 p-2 rounded-lg transition
                                hover:bg-blue-900 hover:text-white">
                <img src="{{ asset('icons/person(dark).png') }}" alt="Accounts" class="w-6 h-6 transition
                                group-hover:invert group-hover:brightness-100">
                <span class="ml-2 md:hidden lg:inline-block">Accounts</span>
            </a>
        </li>
    </ul>
