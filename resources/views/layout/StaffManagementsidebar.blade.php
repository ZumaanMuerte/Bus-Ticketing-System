<div class="fixed top-16 left-0 h-[calc(100vh-64px)] bg-white shadow-md flex flex-col p-5
    ...
    <ul class="space-y-4">
        ...
        <li>
            <a href="{{ route('driver') }}" class="group flex items-center font-semibold text-gray-700 p-2 rounded-lg transition
                                hover:bg-blue-900 hover:text-white">
                <img src="{{ asset('icons/person(dark).png') }}" alt="Person" class="w-6 h-6 transition
                                group-hover:invert group-hover:brightness-100">
                <span class="ml-2 md:hidden lg:inline-block">Driver</span>
            </a>
        </li>
        <li>
            <a href="{{ route('conductor') }}" class="group flex items-center font-semibold text-gray-700 p-2 rounded-lg transition
                                hover:bg-blue-900 hover:text-white">
                <img src="{{ asset('icons/person(dark).png') }}" alt="Person" class="w-6 h-6 transition
                                group-hover:invert group-hover:brightness-100">
                <span class="ml-2 md:hidden lg:inline-block">Conductor</span>
            </a>
        </li>
        <li>
            <a href="{{ route('dispatcher') }}" class="group flex items-center font-semibold text-gray-700 p-2 rounded-lg transition
                                hover:bg-blue-900 hover:text-white">
                <img src="{{ asset('icons/person(dark).png') }}" alt="Person" class="w-6 h-6 transition
                                group-hover:invert group-hover:brightness-100">
                <span class="ml-2 md:hidden lg:inline-block">Dispactcher</span>
            </a>
        </li>
    </ul>
