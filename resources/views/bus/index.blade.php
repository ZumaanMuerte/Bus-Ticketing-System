        ...
        <div class="bg-white shadow rounded-lg p-4">
            ...
            <div class="mb-4">
                <form method="GET" action="" class="flex gap-2">
                    <input type="text" name="search" value="{{ request('search') }}" placeholder="Search bus..." class="border rounded px-4 py-1">
                    <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-black px-4 py-1 rounded">Search</button>
                </form>
            </div>
